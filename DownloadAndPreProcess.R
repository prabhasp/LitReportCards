...
phasemap <- c("2014-03-01"=" Baseline", "2014-04-01"=" Midline", "2014-07-01"="Endline")
learningdata$Phase <- phasemap[as.character(floor_date(learningdata$X_submission_time, 'month'))]
